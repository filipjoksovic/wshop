...
<body>
    ...
    if ($_SESSION['user']['type'] == 'prodavac') {
        ...
        $query =
            "SELECT product_orders.*, products.*, product_images.path FROM product_orders INNER JOIN products on products.id = product_orders.product_id INNER JOIN product_images on products.id = product_images.product_id WHERE product_orders.username = '{$_SESSION['user']['username']}' GROUP BY products.name";
    }
                                    ...
                                    <div class="col-md-8">
                                        <div class="d-flex justify-content-between h-100 flex-column">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span>Ime i prezime preuzimaoca: <?php echo $order['first_name'] . " " . $order['last_name']; ?> </span>
