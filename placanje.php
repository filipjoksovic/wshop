...
<body>
    ...
    <?php
    $sum = 0;
    $productsString = implode(",",$_SESSION['cart']);
    foreach ($_SESSION['cart'] as $in_cart) {
        $query = "SELECT products.price FROM products where products.id = {$in_cart}";
        ...
        <form action="server.php" method="POST" id = "paymentForm">
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input required type="text" name="fname" id="fname" class="form-control" placeholder=""
                        aria-describedby="helpId">
                </div>
                <div class="form-group col-md-6">
                    <label for="lname">Prezime</label>
                    <input required type="text" name="lname" id="lname" class="form-control" placeholder=""
                        aria-describedby="helpId">
                </div>
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input required type="text" name="country" id="fname" class="form-control" placeholder=""
                        aria-describedby="helpId">
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input required type="text" name="zip_code" id="zip_code" class="form-control" placeholder=""
                        aria-describedby="helpId">
                </div>
            </div>
